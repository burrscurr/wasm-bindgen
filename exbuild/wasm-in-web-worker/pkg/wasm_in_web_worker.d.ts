...
declare interface InitOutput {
  ...
  readonly wasm_bindgen__convert__closures__invoke0_mut__h5aca5e1053848faa: (a: number, b: number) => void;
  readonly wasm_bindgen__convert__closures__invoke1_mut__hc8b9461f5856647a: (a: number, b: number, c: number) => void;
