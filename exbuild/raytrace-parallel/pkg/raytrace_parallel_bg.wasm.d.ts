...
export function wasm_bindgen__convert__closures__invoke1_mut__ha5fde86224934eda(a: number, b: number, c: number): void;
export function _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h3b758b3e96ca9e52(a: number, b: number, c: number): void;
